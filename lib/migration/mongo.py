#!/usr/bin/env python
# Copyright (C) 2017 CVEFeed IO
# This file is part of CVEFeed Correlated Vulnerability & Threat Database Python Wrapper  - https://khulnasoft.com
# See the file 'LICENSE' for copying permission.
# Original code by Ushan89 https://github.com/khulnasoft-lab/CVEFeed
...
class Migrate(object):
    ...
    def do_sqlite_to_csv(self, ):
        """ read the CVEFeed.db and export entries to CSV
    ...
    def do_csv_to_mongo(self, ):
        """ read the csv files and populate the CVEFeed MongoDB
        :return: CSV files into csv_exports directory
        """
        ...
        for csv_file in glob.glob(self.csv_dir + '*.csv'):
            ...
            print (("[+] Imported collection: {} --> CVEFeed MongoDB".format(self.table_name)))
