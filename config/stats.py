...
class Stats(object):
    ...
    def get_stats(self):
        """ CVEFeed Statistics  method
        :return: Listing of CVEFeed Database statistics (including third party references)
        """
        self.cur.execute("SELECT * from stat_cvefeed_kpi; ")

        print("---------------------------------------------------------------")
        print("CVEFeed DB Statistics")
    ...
    def get_latest(self):
        ...
        print("---------------------------------------------------------------")
        print("CVEFeed DB Statistics : Latest added CVEs")
