...
# CVEFeed database information
title = "CVEFeed - The Correlated Vulnerability and Threat Intelligence Database API"
author = "CVEFeed IO"
twitter = "@khulnasoft.com"
repository = "https://khulnasoft.com"
build = "0.7.2.1"
